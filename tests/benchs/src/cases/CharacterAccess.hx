...
class CharacterAccess extends TestCase {
	function measureL1() {
		...
		suite.add("mbFastCodeAt(0)", s.mbFastCodeAt(0));
	...
	function measureL100() {
		...
		suite.add("mbFastCodeAt(0)", s.mbFastCodeAt(0));
		suite.add("mbFastCodeAt(50)", s.mbFastCodeAt(50));
		suite.add("mbFastCodeAt(99)", s.mbFastCodeAt(99));
		suite.add("fastCodeAt(0)", s.fastCodeAt(0));
	...
	function measureL10000() {
		...
		suite.add("mbFastCodeAt(0)", s.mbFastCodeAt(0));
		suite.add("mbFastCodeAt(5000)", s.mbFastCodeAt(5000));
		suite.add("mbFastCodeAt(9999)", s.mbFastCodeAt(9999));
		suite.add("fastCodeAt(0)", s.fastCodeAt(0));
	...
	function measureL1000000() {
		...
		suite.add("mbFastCodeAt(0)", s.mbFastCodeAt(0));
		suite.add("mbFastCodeAt(500000)", s.mbFastCodeAt(500000));
		suite.add("mbFastCodeAt(999999)", s.mbFastCodeAt(999999));
		suite.add("fastCodeAt(0)", s.fastCodeAt(0));
